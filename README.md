...
$dm discover --enrich -p projects/my-project
$dm enrich -p projects/my-project
$dm generate-schema --all -p projects/my-project
$dm convert --source projects/my-project/artifacts/generated_schema/full_schema.sql --target postgres -p projects/my-project
$dm validate --phase pre --dataset my_table -p projects/my-project
$dm validate --phase post --dataset my_table -p projects/my-project
$dm prove -d my_table -p projects/my-project
$dm observe --set-baseline -p projects/my-project
...
```
Open **http://localhost:8501** — click through all 6 lifecycle phases, review results, and sign off.
...
| [examples/](examples/) | Working reference projects (unemployment claims, customer service) |
